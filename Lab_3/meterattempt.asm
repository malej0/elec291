...
BSEG
mf: dbit 1 ;flag that is 1 when x and y is the same 
...
measure2:    
	...
	lcall copy_xy
	Load_x(1000000000)
	lcall div32 ; frequency is in x right now 
    ljmp capMeasure
...
capMeasure:
    load_y(3000) ;y = 3000
    lcall mul32 ;x = 3000*f
    lcall copy_xy ; y now has the value of x 
    load_x(1440000) ;divide the two to get the capacitance
    lcall div32
    ljmp printNum
end
