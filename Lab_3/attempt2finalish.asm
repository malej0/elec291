...
printNum:
    ...
    ljmp forever ; Repeat! 
capMeasure:
    load_y(100)  ;since we need to have 144 in the numerator
    lcall div32
    Load_y(144)
    lcall mul32 ;x now has the value of 1.44*t
    load_y(1002) ;resistance value 
	lcall div32
	load_y(116)
    lcall sub32 ;subtracting excess
    ljmp printNum
