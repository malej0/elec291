...
void main (void)  //using ch0 and ch2 for the sin signals 
{
	...
	//char voltage0[8]; //buffer arrays for displaying the values into the LCD
	//char voltage1[8];
	//char halfP0[8];
	//char halfP1[8];
   ...
   // Measure half period at ADC CH2 using timer 0
		...
		pVolt0rms = pVolt0/1.41421356237; //finding rms 
		pVolt1rms = pVolt1/1.41421356237;
		
		printf("channel 0 period(ms):%5.3f\n", time0);
		printf("channel 0 voltage(rms):%f\n", pVolt0rms);
		printf("channel 3 period(ms):%5.3f\n", time1);
		printf("channel 3 voltage(rms):%f\n", pVolt1rms);
